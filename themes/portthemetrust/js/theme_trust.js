...
jQuery(document).ready(function($){
	$("h1.logo a > img, .ideaction-logo > img").hover(
function() {
    $(this).attr("src", "http://kellymobrien:8888/wp-content/uploads/2014/04/ideaction_logoh.png");
},
function() {
    $(this).attr("src", "http://kellymobrien:8888/wp-content/uploads/2014/04/ideaction_logo.png");
}
);
});

jQuery(document).ready(function($){
	$(".tribe-events-page-title").text("Upcoming Engagements");
});
